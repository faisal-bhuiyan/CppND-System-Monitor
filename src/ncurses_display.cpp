...
void NCursesDisplay::DisplayProcesses(std::vector<Process>& processes, WINDOW* window, int n_processes) {
    int row{0};
...
void NCursesDisplay::Display(System& system, int n_processes) {
    ...
    WINDOW* process_window =newwin(3 + n_processes, x_max - 1, system_window->_maxy + 1, 0);
